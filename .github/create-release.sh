...
echo ""
echo "📋 Next steps:"
echo "   1. Check GitHub Actions workflow: https://github.com/tyrads/tyrads-php-sdk-iframe/actions"
echo "   2. Monitor Packagist updates: https://packagist.org/packages/tyrads/tyrads-sdk"
echo "   3. Review GitHub release: https://github.com/tyrads/tyrads-php-sdk-iframe/releases"
echo ""
